...
const CompanionForm = ({
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        ...
        try {
            ...
            console.log(error, 'Something went wrong with the form');
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-8 pb-10'>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                        ...
                        <FormField name='description' control={form.control} render={({ field }) => (
                            <FormItem className='col-span-2 md:col-span-1'>
                                ...
                                <FormControl>
                                    <Input disabled={isLoading} placeholder='Founder of Tesla, CEO of SpaceX' {...field} />
                                </FormControl>
                                <FormDescription >
                    ...
                    <div className='w-full flex justify-center'>
                        <Button size={'lg'} disabled={isLoading} type="submit"> {initialData ? 'Edit your companion' : 'Create your companion'}
